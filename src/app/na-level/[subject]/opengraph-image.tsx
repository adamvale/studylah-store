...
// Per-subject social card (public/og/na-level-<slug>.jpg). Overrides the
...
export const alt = "StudyLah, 2026 N(A)-Level exam forecast";

export default async function Image({ params }: { params: Promise<{ subject: string }> }) {
  const { subject } = await params;
  return subjectOgResponse("na-level", subject);
}
