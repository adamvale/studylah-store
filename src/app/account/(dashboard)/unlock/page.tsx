...
// Shown to signed-in buyers who don't own a Master-tier subject. Their PDFs
// stay fully accessible via orders; StudyLand + the game are the Master perk.
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-14 text-center">
      ...
      <p className="mx-auto mt-3 max-w-md text-body">
        ...
        timers, and StudyLah Legends) unlocks the moment you add the Master tier.
      </p>
