...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        targetMin: 19.5,
        targetMax: 20.5,
        ask: "First find the gravitational potential store with m g h, then set that equal to half m v squared and solve for v.",
        hints: [
          "The gravitational potential store is 0.500 times 10 times 20, which is 100 joules.",
          "Set 100 equal to a half times 0.500 times v squared, so v squared is 400 and v is 20.",
        ],
        working: [
        ...
        explain: "The speed is 20 metres per second. The gravitational potential store is 0.500 kilograms times 10 newtons per kilogram times 20 metres, which is 100 joules. All of it becomes kinetic energy, so a half times 0.500 times v squared is 100, giving v squared of 400 and v of 20.",
      },
      {
        kind: "choice",
        ...
        correct: 0,
        ask: "The gravitational potential store is weight times height. The mass is the weight divided by g, which is 80 kilograms. Set the energy equal to half m v squared.",
        hints: [
          "Weight times height is 800 times 5, which is 4000 joules.",
          "The mass is 80 kilograms, so 4000 equals a half times 80 times v squared, giving v squared of 100 and v of 10.",
        ],
        working: [
        ...
        explain: "The speed is 10 metres per second. The gravitational potential store is 800 newtons times 5 metres, which is 4000 joules. The mass is 800 divided by 10, which is 80 kilograms, so a half times 80 times v squared is 4000, giving v squared of 100 and v of 10.",
      },
      {
        kind: "choice",
