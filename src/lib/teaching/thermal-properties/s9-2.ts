...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        correct: 2,
        ask: "Use Q equals m c theta. The temperature change is 70 - 20, which is 50. Work out 2.0 × 4200 × 50.",
        hints: [
          "First find the temperature change: 70 - 20 is 50.",
        ...
        explain: "The energy transferred is 4.2 × 10 to the power 5 joules, because 2.0 kilograms times 4200 times a 50 degree change is 420000 joules.",
      },
      {
        kind: "slider",
        ...
        targetMin: 26500,
        targetMax: 27500,
        ask: "Use Q equals m c theta. The temperature change is 85 - 25, which is 60. Work out 0.50 × 900 × 60.",
        hints: [
          "The temperature change is 85 - 25, which is 60.",
          "0.50 × 900 × 60 is 27000, which is 2.7 × 10 to the power 4 joules.",
        ],
        working: [
          { label: "Formula", latex: "Q = m c \\theta" },
        ...
        explain: "The energy transferred is 2.7 × 10 to the power 4 joules, because 0.50 kilograms times 900 times a 60 degree change is 27000 joules.",
      },
      {
        kind: "choice",
        ...
        correct: 1,
        ask: "Heat capacity is energy divided by temperature change, so work out 3000 ÷ 25.",
        hints: [
          "Use C equals Q divided by theta.",
          "3000 ÷ 25 is 120, in joules per degree Celsius.",
        ],
        working: [
      ...
      },
      {
        ...
        correct: 3,
        ask: "Specific heat capacity is the heat capacity divided by the mass, so work out 120 ÷ 0.40.",
        hints: [
          "Use c equals C divided by m.",
          "120 ÷ 0.40 is 300, in joules per kilogram per degree Celsius.",
        ],
        working: [
        ...
        explain: "The specific heat capacity is 300 joules per kilogram per degree Celsius, because 120 ÷ 0.40 kilograms is 300.",
      },
      {
        kind: "slider",
        ...
        targetMin: 9.5,
        targetMax: 10.5,
        ask: "Rearrange Q equals m c theta to get theta equals Q divided by m c. Work out 63000 ÷ 1.5 × 4200.",
        hints: [
          "First find m times c: 1.5 × 4200 is 6300.",
          "63000 ÷ 6300 is 10 degrees Celsius.",
        ],
        working: [
        ...
        explain: "The temperature rise is 10 degrees Celsius, because 63000 joules divided by 6300 (that is 1.5 × 4200) is 10.",
      },
      {
        kind: "choice",
