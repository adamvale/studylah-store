...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "For water l_v (2.26 times 10 to the power 6 J/kg) is *much larger* than l_f (3.36 times 10 to the power 5 J/kg), because *boiling* pulls the particles *completely apart* while melting only loosens them.",
      ...
      },
      {
        ...
        correct: 2,
        ask: "The energy for melting is the specific latent heat of fusion times the mass, so work out 3.36 times 10 to the power 5 times 2.0.",
        hints: [
          "Use L_f equals l_f times m.",
          "3.36 times 10 to the power 5 times 2.0 is 6.72 times 10 to the power 5.",
        ],
        working: [
        ...
        explain: "The energy is 6.72 times 10 to the power 5 joules, because 3.36 times 10 to the power 5 joules per kilogram times 2.0 kilograms is 6.72 times 10 to the power 5 joules.",
      },
      {
        kind: "choice",
        ...
        correct: 0,
        ask: "The energy for boiling is the specific latent heat of vaporisation times the mass, so work out 2.26 times 10 to the power 6 times 0.50.",
        hints: [
          "Use L_v equals l_v times m.",
          "2.26 times 10 to the power 6 times 0.50 is 1.13 times 10 to the power 6.",
        ],
        working: [
        ...
        explain: "The energy is 1.13 times 10 to the power 6 joules, because 2.26 times 10 to the power 6 joules per kilogram times 0.50 kilograms is 1.13 times 10 to the power 6 joules.",
      },
      {
        kind: "choice",
        ...
        correct: 3,
        ask: "Rearrange L_v equals l_v times m to get l_v equals the energy divided by the mass, so work out 452000 divided by 0.20.",
        hints: [
          "The specific latent heat is the energy divided by the mass.",
          "452000 divided by 0.20 is 2260000, which is 2.26 times 10 to the power 6.",
        ],
        working: [
        ...
        explain: "The specific latent heat is 2.26 times 10 to the power 6 joules per kilogram, because 452000 joules divided by 0.20 kilograms is 2260000 joules per kilogram.",
      },
      {
        kind: "choice",
        ...
        correct: 1,
        ask: "Add the melting energy l_f times m to the heating energy m times c times the temperature change. Work out 336000 plus 84000.",
        hints: [
          "The melting step is 3.36 times 10 to the power 5 times 1.0, and the heating step is 1.0 times 4200 times 20.",
          "336000 plus 84000 is 420000, which is 4.2 times 10 to the power 5.",
        ],
        working: [
        ...
        explain: "The total energy is 4.2 times 10 to the power 5 joules, because the melting step gives 336000 joules and the heating step gives 84000 joules, and their sum is 420000 joules.",
      },
      {
        kind: "choice",
