...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        correct: 2,
        ask: "The p.d. across the LDR is its resistance over the total resistance, times the supply. Work out 300 divided by 2300, then times 20.",
        hints: [
          "The total resistance is 300 plus 2000, which is 2300 ohms.",
          "300 divided by 2300 is about 0.13, and 0.13 times 20 is about 2.6.",
        ],
        working: [
        ...
        explain: "The p.d. across the LDR is 2.6 volts, because 300 divided by 2300 is about 0.13, and 0.13 times 20 volts is 2.6 volts. In daylight the LDR's low resistance keeps only a small share of the supply.",
      },
      {
        kind: "choice",
        ...
        correct: 0,
        ask: "Use the same divider rule with the night value. The total is now 5000 plus 2000, so work out 5000 divided by 7000, then times 20.",
        hints: [
          "The total resistance at night is 5000 plus 2000, which is 7000 ohms.",
          "5000 divided by 7000 is about 0.71, and 0.71 times 20 is about 14.3.",
        ],
        working: [
          { label: "Formula", latex: "V_{LDR} = \\dfrac{R_{LDR}}{R_{LDR} + R} \\times V_{in}" },
        ...
        explain: "The p.d. across the LDR is 14.3 volts, because 5000 divided by 7000 is about 0.71, and 0.71 times 20 volts is 14.3 volts. In the dark the LDR's high resistance takes most of the supply.",
      },
      {
        kind: "choice",
