...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      {
        kind: "choice",
        question: "Orange light has a wavelength of 6.0 × 10^{-7} m. Using v = 3.0 × 10^{8} m/s, find its frequency.",
        options: [
          "1.8 × 10^{2} Hz",
          "5.0 × 10^{13} Hz",
          "2.0 × 10^{-15} Hz",
        ...
        hints: [
          ...
          "3.0 × 10 to the power 8 ÷ 6.0 × 10 to the power negative 7 is 5.0 × 10 to the power 14.",
        ],
        working: [
        ...
        explain: "The frequency is 5.0 × 10 to the power 14 hertz, because 3.0 × 10 to the power 8 metres per second divided by 6.0 × 10 to the power negative 7 metres gives 5.0 × 10 to the power 14 hertz.",
      },
      {
        kind: "choice",
        question: "An FM radio station broadcasts at a frequency of 9.0 × 10^{7} Hz. Using v = 3.0 × 10^{8} m/s, find its wavelength.",
        options: [
          "0.33 m",
          "3.3 m",
          "33 m",
        ...
        hints: [
          ...
          "3.0 × 10 to the power 8 ÷ 9.0 × 10 to the power 7 is about 3.3.",
        ],
        working: [
        ...
        explain: "The wavelength is 3.3 metres, because 3.0 × 10 to the power 8 metres per second divided by 9.0 × 10 to the power 7 hertz gives about 3.3 metres.",
      },
      {
        kind: "choice",
      ...
      },
      {
        ...
        lines: [
          ...
          "In a vacuum all EM waves travel at 3.0 × 10^{8} m/s.",
        ],
        errorLine: 2,
      ...
      {
        kind: "tiles",
        prompt: "An X-ray has a frequency of 1.5 × 10^{18} Hz. Using v = 3.0 × 10^{8} m/s, build the working line that gives its wavelength.",
        tiles: [
          "\\lambda =",
          "3.0 \\times 10^{8}",
          "\\div",
        ...
        ask: "To find wavelength, divide the speed by the frequency, so set up 3.0 × 10 to the power 8 ÷ 1.5 × 10 to the power 18.",
        hints: [
          "From v = f lambda, the wavelength lambda is v divided by f.",
          "3.0 × 10 to the power 8 ÷ 1.5 × 10 to the power 18 is 2.0 × 10 to the power negative 10, in metres.",
        ],
        working: [
          { label: "Formula", latex: "\\lambda = \\dfrac{v}{f}" },
        ...
        explain: "The wavelength is 2.0 × 10 to the power negative 10 metres, because 3.0 × 10 to the power 8 metres per second divided by 1.5 × 10 to the power 18 hertz gives 2.0 × 10 to the power negative 10 metres.",
      },
      {
        kind: "open",
        prompt: "State what an electromagnetic wave is and give 2 properties shared by every electromagnetic wave.",
        modelAnswer: "An electromagnetic wave is a transverse wave made of an oscillating electric field and an oscillating magnetic field at right angles to each other and to the direction of travel. All EM waves transfer energy without matter, travel through a vacuum at 3.0 × 10 to the power 8 metres per second, and obey v = f lambda. Any 2 of these shared properties are acceptable.",
        marks: [
          "An EM wave is a transverse wave of oscillating electric and magnetic fields at right angles.",
          "Property 1: all EM waves travel through a vacuum at 3.0 × 10^{8} m/s.",
