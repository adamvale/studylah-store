...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      {
        kind: "choice",
        question: "Orange light has a wavelength of 6.0 × 10^{-7} m. EM waves travel at 3.0 × 10^{8} m/s. What is its frequency?",
        options: [
          "1.8 × 10^{2} Hz",
          "5.0 × 10^{14} Hz",
          "5.0 × 10^{15} Hz",
        ...
        correct: 1,
        ask: "Frequency is speed divided by wavelength, so work out 3.0 × 10 to the power 8 ÷ 6.0 × 10 to the power negative 7.",
        hints: [
      ...
      {
        kind: "slider",
        prompt: "An FM radio station broadcasts at a frequency of 9.0 × 10^{7} Hz. EM waves travel at 3.0 × 10^{8} m/s. Set the slider to the wavelength, in metres.",
        min: 0,
        max: 10,
        step: 0.1,
        unit: "m",
        ...
        targetMin: 3.2,
        targetMax: 3.4,
        ask: "Wavelength is speed divided by frequency, so work out 3.0 × 10 to the power 8 ÷ 9.0 × 10 to the power 7.",
        hints: [
          "Rearrange v equals f lambda into lambda equals v over f.",
          "3.0 × 10 to the power 8 ÷ 9.0 × 10 to the power 7 is about 3.3, so slide to 3.3 metres.",
        ],
        working: [
        ...
        explain: "The wavelength is about 3.3 metres, because 3.0 × 10 to the power 8 ÷ 9.0 × 10 to the power 7 is 3.3.",
      },
      {
        kind: "choice",
        question: "An X-ray has a frequency of 1.5 × 10^{18} Hz. EM waves travel at 3.0 × 10^{8} m/s. What is its wavelength?",
        options: [
          "2.0 × 10^{-10} m",
          "2.0 × 10^{10} m",
          "5.0 × 10^{9} m",
        ...
        correct: 0,
        ask: "Wavelength is speed divided by frequency, so work out 3.0 × 10 to the power 8 ÷ 1.5 × 10 to the power 18.",
        hints: [
          "Rearrange v equals f lambda into lambda equals v over f.",
