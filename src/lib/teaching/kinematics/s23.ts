...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        explain: "She travels 2400 metres, because 8 metres per second times 300 seconds is 2400 metres.",
      },
      {
        kind: "order",
      ...
      },
      {
        ...
        explain: "The average speed is 8.8 metres per second, because 5280 metres divided by 600 seconds is 8.8.",
      },
      {
        kind: "choice",
        ...
        explain: "The rest lowers the average speed, because it adds 60 seconds to the total time while adding no distance, so the same distance is shared over more time.",
      },
      {
        kind: "insight",
        body: "*Average speed* is not the average of the separate speeds. Always go back to *total distance* over *total time*.",
        say: "Here is the trap to remember. Average speed is almost never just the middle of the speeds you were given. You cannot simply add 8 and 12 and halve it. Always return to the definition: total distance over total time, counting every stop. Trust the totals, and you will get it right every time.",
      },
    ],
  },
];
