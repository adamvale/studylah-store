...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      // 1 (distance from speed) correct = 3
      {
        ...
        explain: "The distance is 720 metres, because 4 metres per second times 180 seconds is 720.",
      },
      ...
      // 7 (displacement of constant part, self-contained numbers) correct = 0
      {
        ...
        explain: "The displacement is 72 metres, because during the constant part the area is 12 metres per second times 6 seconds, which is 72.",
      },
      // 8 (average speed of whole journey, same object) correct = 2
      {
        ...
        explain: "The average speed is 9 metres per second, because the total distance of 108 metres divided by the total time of 12 seconds is 9.",
      },
      ...
      // 10 (which v-t graph, worded shapes) correct = 1
      {
        ...
        correct: 1,
        ask: "First the velocity rises steadily from 0, then it stops changing. What two shapes joined together show that?",
        hints: [
          "Accelerating from rest is a line sloping up from 0.",
      ...
      // 4 tiles (build v^2 = u^2 + 2ad)
      {
        ...
        hints: [
          ...
          "The right side is the starting velocity squared plus 2 times acceleration times displacement.",
        ],
      ...
      // 5 cloze (free fall)
      {
        ...
        hints: [
          "The velocity gained each second is 10 metres per second.",
          "The acceleration of free fall is about 10 metres per second squared.",
        ],
        explain: "A freely falling object gains 10 metres per second of velocity every second, so its free fall acceleration is about 10 metres per second squared.",
      },
      ...
      // 8 graphpick (v-t uniform acceleration from rest)
      {
        ...
        correct: 0,
        ask: "Uniform acceleration means the velocity climbs by the same amount each second, and from rest means it starts at 0. What shape is that?",
        hints: [
          "Uniform acceleration is a straight, sloping line.",
          "From rest means it begins at 0 velocity.",
        ],
        explain: "A straight line sloping up from 0 shows uniform acceleration from rest: the velocity gains the same amount every second. The curve would be a changing acceleration, and the flat line would be 0 acceleration.",
      },
      ...
      // 1 (ball from 80 m, 4 s)
      {
        ...
        ask: "For the average speed, divide the 80 metres by the 4 seconds. For the maximum velocity, the ball starts from rest and gains 10 metres per second every second, so use final velocity equals starting velocity plus acceleration times time.",
      },
      // 2 (car from rest, 30 m in 10 s)
      {
        ...
        ask: "First find the average speed as 30 over 10. Because it starts from rest with uniform acceleration, the average speed is half the final velocity, so double it to get the final velocity. Then find the acceleration as the change in velocity divided by the time.",
      },
      ...
      // 4 (multi-stage journey, distance and average speed)
      {
        ...
        ask: "Find each acceleration as the change in velocity over its time. For the distance, add up the areas under the velocity-time graph: a trapezium, then a rectangle, then a triangle. Finally divide the total distance by the total time of 25 seconds.",
      },
