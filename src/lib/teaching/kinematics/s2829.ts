...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        explain: "The equation is d equals u t plus a half a t^2. It uses the starting velocity, the acceleration and the time, and leaves out the final velocity.",
        ...
        hints: [
          ...
          "Add a half a t^2. There is no v^2 in this one.",
        ],
      },
      {
        kind: "choice",
        ...
        correct: 1,
        ask: "Work out u times t, that is 50 × 8. Then a half times 4 × 8^2. Add the 2 parts. Which option is that?",
        hints: [
          "The first part is 50 × 8, which is 400.",
          "The second part is a half times 4 × 64, which is 128. Now add them.",
        ],
        working: [
        ...
        explain: "The displacement is 528 metres. 50 × 8 is 400, and a half times 4 × 8^2 is 128, and 400 + 128 is 528.",
      },
      {
        kind: "spoterror",
        ...
        errorLine: 3,
        ask: "Check the last line. 6 + 10. Is that 26?",
        hints: [
          "Work out 6 + 10 carefully.",
          "6 + 10 is 16, not 26.",
        ],
        working: [
        ...
        explain: "The last line is wrong: 6 + 10 is 16, so the final velocity is 16 metres per second.",
      },
      {
        kind: "insight",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        explain: "After 3 seconds the velocity is 30 metres per second, because it gains 10 metres per second every second, and 10 × 3 is 30.",
        ...
        hints: [
          ...
          "10 × 3 seconds is 30 metres per second.",
        ],
      },
      {
        kind: "choice",
      ...
      },
      {
        ...
        correct: 0,
        ask: "It starts from rest, so v equals 0 + 10 × 3. Which option is that?",
        hints: [
        ...
        explain: "The velocity is 30 metres per second, because starting from rest, v equals 0 + 10 × 3, which is 30.",
      },
      {
        kind: "order",
