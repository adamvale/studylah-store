...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        correct: 0,
        ask: "Balanced means the 2 moments are equal, so set 30 times 0.4 equal to W times 0.2, then divide to get W.",
        hints: [
          "The anticlockwise moment is 30 times 0.4, which is 12 newton metres.",
          "12 divided by 0.2 is 60, and W is a force in newtons.",
        ],
        working: [
        ...
        explain: "The weight is 60 newtons, because 30 newtons times 0.4 metres is 12 newton metres, and 12 divided by 0.2 metres is 60 newtons.",
      },
      {
        kind: "order",
      ...
      },
      {
        ...
        targetMin: 1490,
        targetMax: 1510,
        ask: "Balanced means P times 0.4 equals 400 times 1.5, so work out the load's moment first, then divide by 0.4.",
        hints: [
          "The load's moment is 400 times 1.5, which is 600 newton metres.",
          "600 divided by 0.4 is 1500, so slide to 1500 newtons.",
        ],
        working: [
          { label: "Formula", latex: "F_1 \\times d_1 = F_2 \\times d_2" },
        ...
        explain: "The counterweight force is 1500 newtons, because 400 newtons times 1.5 metres is 600 newton metres, and 600 divided by 0.4 metres is 1500 newtons. That force is the weight of a 150 kilogram mass.",
      },
      {
        kind: "tiles",
        ...
        ask: "The load's moment is 500 times 6, and that equals T times 2.5, so divide the load's moment by 2.5.",
        hints: [
          "The clockwise moment is 500 times 6, which is 3000 newton metres.",
          "3000 divided by 2.5 is 1200, and the tension is a force in newtons.",
        ],
        working: [
        ...
        explain: "The string tension is 1200 newtons, because 500 newtons times 6 metres is 3000 newton metres, and 3000 divided by 2.5 metres is 1200 newtons.",
      },
      {
        kind: "choice",
        ...
        hints: [
          "20 times 0.3 is 6, and 12 times 0.2 is 2.4, so the total anticlockwise moment is 8.4 newton metres.",
          "8.4 divided by 0.1 is 84, and W is a force in newtons.",
        ],
        working: [
        ...
        explain: "The weight is 84 newtons, because the 2 anticlockwise moments add to 6 plus 2.4, which is 8.4 newton metres, and 8.4 divided by 0.1 metres is 84 newtons.",
      },
      {
        kind: "insight",
