...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        correct: 2,
        ask: "First find the energy: 2 times 4 gives the kilowatt-hours. Then multiply that by 0.25 to get the cost.",
        hints: [
          "Energy equals power times time, so 2 kilowatts times 4 hours is 8 kilowatt-hours.",
          "Cost is energy times price, so 8 times 0.25 is 2.00 dollars.",
        ],
        working: [
        ...
        explain: "The heater uses 8 kilowatt-hours, because 2 kilowatts times 4 hours is 8, and 8 times 0.25 dollars is 2.00 dollars.",
      },
      {
        kind: "choice",
        ...
        correct: 0,
        ask: "Work out the energy first: 2.4 times 5 in kilowatt-hours. Then multiply by 0.28 for the cost.",
        hints: [
          "Energy is 2.4 kilowatts times 5 hours, which is 12 kilowatt-hours.",
          "Cost is 12 times 0.28, which is 3.36 dollars.",
        ],
        working: [
          { label: "Formula", latex: "E = P\\,t,\\quad \\text{cost} = E \\times \\text{price}" },
        ...
        explain: "The air conditioner uses 12 kilowatt-hours, because 2.4 kilowatts times 5 hours is 12, and 12 times 0.28 dollars is 3.36 dollars.",
      },
      {
        kind: "choice",
        ...
        correct: 1,
        ask: "Rearrange energy equals power times time to get power, so divide the energy by the time: 12 divided by 0.5.",
        hints: [
          "Power equals energy divided by time.",
          "12 divided by 0.5 is 24, so the power is 24 kilowatts.",
        ],
        working: [
      ...
      },
      {
        ...
        correct: 3,
        ask: "Rearrange energy equals power times time to get time, so divide the energy by the power: 0.5 divided by 0.2.",
        hints: [
          "Time equals energy divided by power.",
          "0.5 divided by 0.2 is 2.5, so the fan ran for 2.5 hours.",
        ],
        working: [
      ...
      },
      {
        ...
        hints: [
          ...
          "1 kilowatt-hour is 3.6 times 10 to the power 6 joules, so it replaces millions of joules with a small, readable number.",
        ],
