...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        targetMin: 84.5,
        targetMax: 85.5,
        ask: "The gas is above atmospheric, so add the height difference to atmospheric pressure. Work out 76 + 9.0.",
        hints: [
          "Use P_gas equals P_atm plus the height difference measured in cm Hg.",
          "76 + 9.0 is 85, so slide to 85 cm Hg.",
        ],
        working: [
        ...
        explain: "The gas pressure is 85 cm Hg, because 76 + 9.0 is 85. Converting, 0.85 metres of mercury times its density 1.36 × 10 to the power 4 kilograms per cubic metre times 10 gives 1.16 × 10 to the power 5 pascals.",
      },
      {
        kind: "tiles",
        ...
        ask: "The pressures balance at the boundary, so h1 rho1 equals h2 rho2. Rearrange for the water height and work out 20 × 800 ÷ 1000.",
        hints: [
          "From h1 rho1 equals h2 rho2, the water height is 20 × 800 ÷ 1000.",
          "20 × 800 is 16000, and 16000 ÷ 1000 is 16.",
        ],
        working: [
        ...
        explain: "The water column is 16 centimetres tall, because 20 × 800 ÷ 1000 is 16. The denser water needs a shorter column to balance the taller column of lighter oil.",
      },
      {
        kind: "insight",
