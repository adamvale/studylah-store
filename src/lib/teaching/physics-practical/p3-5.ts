...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        correct: 0,
        ask: "Use M = m times x over y. Work out 0.050 times 6.05 divided by 6.10.",
        hints: [
          "The 2 distances share a unit, so just use their ratio 6.05 over 6.10.",
          "6.05 divided by 6.10 is very close to 1, so 0.050 times that is about 0.050 kilograms.",
        ],
        working: [
        ...
        explain: "The rule's mass is 0.050 kilograms, because 6.05 divided by 6.10 is almost exactly 1, so 0.050 times that ratio stays at 0.050 kilograms.",
      },
      {
        kind: "choice",
        ...
        hints: [
          ...
          "50 divided by 100 is 0.5, so the gradient is the ratio of the 2 masses.",
        ],
      ...
      },
      {
        ...
        correct: 3,
        ask: "The intercept equals M over 100, so M is 100 times the intercept. Work out 100 times 0.98.",
        hints: [
          "Multiply the intercept by 100 to undo the divide by 100.",
          "100 times 0.98 is 98, in grams.",
        ],
        working: [
        ...
        explain: "The rule's mass is 98 grams, because the intercept 0.98 equals M over 100, so M is 100 times 0.98.",
      },
      {
        kind: "slider",
        ...
        targetMin: 89,
        targetMax: 91,
        ask: "The intercept equals M over 100, so multiply the intercept by 100. Work out 100 times 0.90.",
        hints: [
          "M is 100 times the intercept.",
          "100 times 0.90 is 90, so slide to 90 grams.",
        ],
        working: [
          { label: "Formula", latex: "\\text{intercept} = \\dfrac{M}{100}" },
        ...
        explain: "The rule's mass is 90 grams, because the intercept 0.90 equals M over 100, so M is 100 times 0.90.",
      },
    ],
  },
];
