...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        correct: 0,
        ask: "Put the readings into theta = (X_theta minus X_0) over (X_100 minus X_0), all times 100. Work out 77 minus 50 over 95 minus 50.",
        hints: [
          "The gap above the ice point is 77 minus 50, which is 27. The full gap is 95 minus 50, which is 45.",
          "27 divided by 45 is 0.6, and 0.6 times 100 is 60 degrees Celsius.",
        ],
        working: [
        ...
        explain: "The temperature is 60 degrees Celsius, because 77 minus 50 is 27, 95 minus 50 is 45, and 27 divided by 45 times 100 gives 60.",
      },
      {
        kind: "choice",
        ...
        correct: 3,
        ask: "Use Q equals m times c times DeltaTheta. Work out 0.50 times 4200 times 60.",
        hints: [
          "0.50 times 4200 is 2100 joules for every 1 degree Celsius of rise.",
          "2100 times 60 is 126000 joules, which is 1.26 times 10 to the power 5 joules.",
        ],
        working: [
        ...
        explain: "The heat needed is 1.26 times 10 to the power 5 joules, because 0.50 times 4200 times 60 is 126000 joules.",
      },
      {
        kind: "choice",
      ...
      },
      {
        ...
        correct: 2,
        ask: "Use L equals l_f times m. Work out 3.34 times 10 to the power 5, times 0.20.",
        hints: [
          "Multiply the specific latent heat by the mass, so 3.34 times 10 to the power 5 times 0.20.",
          "3.34 times 0.20 is 0.668, so the answer is 6.68 times 10 to the power 4 joules.",
        ],
        working: [
        ...
        explain: "The heat needed is 6.68 times 10 to the power 4 joules, because 3.34 times 10 to the power 5 times 0.20 is 66800 joules.",
      },
      {
        kind: "classify",
      ...
      },
      {
        ...
        targetMin: 22,
        targetMax: 24,
        ask: "Rearrange Q equals m times c times DeltaTheta to get DeltaTheta equals Q over m times c. Work out 18000 divided by 2.0 times 385.",
        hints: [
          "First find m times c, which is 2.0 times 385, equal to 770 joules per degree Celsius.",
          "18000 divided by 770 is about 23, so slide to 23 degrees Celsius.",
        ],
        working: [
        ...
        explain: "The temperature rise is about 23 degrees Celsius, because 2.0 times 385 is 770 joules per degree Celsius, and 18000 divided by 770 is roughly 23.",
      },
      {
        kind: "tiles",
        ...
        ask: "Use L equals l_f times m, so multiply 3.34 times 10 to the power 5 by 0.30.",
        hints: [
          "Freezing releases the same latent heat that melting would absorb, so use L equals l_f times m.",
          "3.34 times 0.30 is about 1.0, so the answer is 1.0 times 10 to the power 5 joules.",
        ],
        working: [
          { label: "Formula", latex: "L = l_f m" },
        ...
        explain: "The heat released is 1.0 times 10 to the power 5 joules, because 3.34 times 10 to the power 5 times 0.30 is about 100000 joules.",
      },
      {
        kind: "open",
