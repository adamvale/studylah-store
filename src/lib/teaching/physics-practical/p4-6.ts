...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        correct: 0,
        ask: "The specific latent heat of fusion is the power divided by the gradient. Work out 100 divided by 2.99 times 10 to the power negative 4.",
        hints: [
        ...
        explain: "l_f is 3.3 times 10 to the power 5 joules per kilogram, because 100 watts divided by 2.99 times 10 to the power negative 4 kilograms per second is about 3.3 times 10 to the power 5.",
      },
      {
        kind: "choice",
      ...
      },
      {
        ...
        correct: 3,
        ask: "The specific latent heat of vaporisation is the power divided by the gradient. Work out 100 divided by 4.39 times 10 to the power negative 5.",
        hints: [
          "Use l_v equals P divided by the gradient.",
          "100 divided by 4.39 times 10 to the power negative 5 is about 2.3 times 10 to the power 6.",
        ],
        working: [
        ...
        explain: "l_v is 2.3 times 10 to the power 6 joules per kilogram, because 100 watts divided by 4.39 times 10 to the power negative 5 kilograms per second is about 2.3 times 10 to the power 6.",
      },
      {
        kind: "slider",
        ...
        targetMin: 2.2,
        targetMax: 2.4,
        ask: "l_v is the power divided by the gradient, so work out 60 divided by 2.67 times 10 to the power negative 5, then read it in units of 10 to the power 6.",
        hints: [
          "Use l_v equals P divided by the gradient.",
          "60 divided by 2.67 times 10 to the power negative 5 is about 2.3 times 10 to the power 6, so slide to 2.3.",
        ],
        working: [
          { label: "Formula", latex: "l_v = \\dfrac{P}{\\text{gradient}}" },
        ...
        explain: "l_v is about 2.3 times 10 to the power 6 joules per kilogram, because 60 watts divided by 2.67 times 10 to the power negative 5 kilograms per second is about 2.3 times 10 to the power 6.",
      },
    ],
  },
];
