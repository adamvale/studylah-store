...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        correct: 2,
        ask: "Use 1/f = 1/u + 1/v. Work out 1 divided by 25.0, then 1 divided by 75.0, add them, then take the reciprocal.",
        hints: [
          "1 over 25.0 is 0.0400 and 1 over 75.0 is 0.0133.",
          "0.0400 plus 0.0133 is 0.0533, and 1 divided by 0.0533 is about 18.8.",
        ],
        working: [
        ...
        explain: "The focal length is 18.8 centimetres, because 1 over 25.0 plus 1 over 75.0 is 0.0533 per centimetre, and 1 divided by 0.0533 is 18.8. The trap 0.0533 is the value of 1 over f, not f itself.",
      },
      {
        kind: "graphpick",
        ...
        hints: [
          ...
          "The gradient is 17.1 minus 7.5 over 94.6 minus 44.2, which is 9.6 over 50.4, about 0.19.",
        ],
      ...
      },
      {
        ...
        correct: 0,
        ask: "The gradient equals 1 over f, so f is 1 divided by the gradient. Work out 1 divided by 0.190.",
        hints: [
          "The gradient of m against v is 1 over f, so f = 1 divided by the gradient.",
          "1 divided by 0.190 is about 5.3.",
        ],
        working: [
        ...
        explain: "The focal length is 5.3 centimetres, because the gradient 0.190 per centimetre equals 1 over f, and 1 divided by 0.190 is 5.3. The value 0.190 is the gradient itself, not f.",
      },
      {
        kind: "choice",
        ...
        correct: 1,
        ask: "Use f = (D^2 - d^2)/(4D). Square 100.0, square 58.8, subtract, then divide by 4 times 100.0.",
        hints: [
          "100.0 squared is 10000 and 58.8 squared is 3457, so the top is 6543.",
          "4 times 100.0 is 400, and 6543 divided by 400 is about 16.4.",
        ],
        working: [
        ...
        explain: "The focal length is 16.4 centimetres, because 10000 minus 3457 is 6543, and 6543 divided by 400 is 16.4. The trap 41.2 is D minus d, and 6543 is only the numerator before dividing.",
      },
      {
        kind: "open",
