    ...
    steps: [
      {
        ...
        correct: 2,
        ask: "Resistance is voltage divided by current, so work out 12 ÷ 0.50. Which option is that?",
        hints: [
          "Use R equals V divided by I.",
          "12 ÷ 0.50 is 24, and resistance is measured in ohms.",
        ],
        working: [
      ...
      },
      {
        ...
        correct: 3,
        ask: "Use V_out equals R_2 divided by the sum R_1 plus R_2, all times the supply voltage. Work out 6.0 over 10.0 × 5.0.",
        hints: [
          "The output fraction is R_2 divided by the total resistance, 4.0 + 6.0.",
        ...
        explain: "The output is 3.0 volts, because 6.0 ÷ 10.0 is 0.6, and 0.6 × 5.0 volts is 3.0 volts. The larger share of the voltage sits across the larger resistor.",
      },
      {
        kind: "choice",
        ...
        correct: 1,
        ask: "Resistors in series add up. Work out 25 + 50 + 75.",
        hints: [
        ...
        explain: "The total resistance is 150 ohms, because resistors in series simply add and 25 + 50 + 75 is 150 ohms.",
      },
      {
        kind: "choice",
      ...
      },
      {
        ...
        targetMin: 5.9,
        targetMax: 6.1,
        ask: "The output fraction is R_2 divided by the total, 3.0 + 6.0. Work out 6.0 over 9.0 × 9.0.",
        hints: [
          "Use V_out equals R_2 over R_1 plus R_2, times the supply voltage.",
          "6.0 ÷ 9.0 is 0.667, and 0.667 × 9.0 is 6.0 volts.",
        ],
        working: [
          { label: "Formula", latex: "V_{out} = \\dfrac{R_2}{R_1 + R_2}\\,V" },
        ...
        explain: "The output is 6.0 volts, because 6.0 ÷ 9.0 is 0.667, and 0.667 × 9.0 volts is 6.0 volts. 2 thirds of the resistance carries 2 thirds of the voltage.",
      },
      {
        kind: "tiles",
        ...
        hints: [
          "Use R equals V divided by I.",
          "9.30 ÷ 1.52 is 6.12, and resistance is measured in ohms.",
        ],
        working: [
          { label: "Formula", latex: "R = \\dfrac{V}{I}" },
