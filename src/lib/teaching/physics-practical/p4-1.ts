...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        correct: 1,
        ask: "Put the values into the thermometry formula. Work out 510 - 820 on top, then 200 - 820 on the bottom, divide, and multiply by 100.",
        hints: [
          "The top is 510 - 820, which is negative 310; the bottom is 200 - 820, which is negative 620.",
          "Negative 310 divided by negative 620 is 0.5, and 0.5 × 100 is 50.",
        ],
        working: [
        ...
        explain: "The temperature is 50 degrees Celsius, because 510 - 820 is negative 310, and 200 - 820 is negative 620, and negative 310 divided by negative 620 is 0.5, × 100 is 50.",
      },
      {
        kind: "choice",
        ...
        correct: 0,
        ask: "Use the thermometry formula. The top is 77 - 50, the bottom is 95 - 50, then divide and multiply by 100.",
        hints: [
          "The top is 77 - 50, which is 27; the bottom is 95 - 50, which is 45.",
          "27 ÷ 45 is 0.6, and 0.6 × 100 is 60.",
        ],
        working: [
          { label: "Formula", latex: "\\theta = \\dfrac{X_\\theta - X_0}{X_{100} - X_0} \\times 100" },
        ...
        explain: "The temperature is 60 degrees Celsius, because 77 - 50 is 27, and 95 - 50 is 45, and 27 ÷ 45 is 0.6, × 100 is 60.",
      },
      {
        kind: "insight",
