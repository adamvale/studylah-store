...
export const BOXES: Subconcept[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        correct: 2,
        ask: "Frequency is 1 divided by the period, so work out 1 ÷ 0.25.",
        hints: [
          "Use f equals 1 over T with T of 0.25 seconds.",
          "1 ÷ 0.25 is 4, so the frequency is 4 hertz.",
        ],
        working: [
        ...
        explain: "The frequency is 4 hertz, because 1 ÷ 0.25 seconds is 4 oscillations per second.",
      },
      {
        kind: "choice",
        ...
        hints: [
          ...
          "1 ÷ 25 is 0.04, so the period is 0.04 seconds.",
        ],
        working: [
        ...
        explain: "The period is 0.04 seconds, because 1 ÷ 25 hertz is 0.04 seconds for one oscillation.",
      },
      {
        kind: "choice",
      ...
      },
      {
        ...
        options: ["240", "64", "15", "4"],
        correct: 0,
        ask: "Frequency is waves per second, so multiply the frequency by the time. Work out 4 × 60.",
        hints: [
          "Number of waves is frequency times time.",
          "4 × 60 is 240, so 240 complete waves are made.",
        ],
        working: [
        ...
        explain: "There are 240 complete waves, because 4 waves per second for 60 seconds gives 4 × 60, which is 240.",
      },
      {
        kind: "slider",
        ...
        hints: [
          "The period is 1.2 ÷ 3, which is 0.4 seconds.",
          "1 ÷ 0.4 is 2.5, so slide to 2.5 hertz.",
        ],
        working: [
        ...
        explain: "The frequency is 2.5 hertz, because 3 cycles in 1.2 seconds is a period of 0.4 seconds, and 1 ÷ 0.4 is 2.5.",
      },
      {
        kind: "insight",
